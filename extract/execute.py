...
if __name__ == "__main__":
    ...
    # Set up logger specific for extract module
    log_file = os.path.join(os.path.dirname(__file__), "extract.log")
    ...
    try:
        ...
        logger.error(f"Extract module failed: {e}")
        sys.exit(1)
